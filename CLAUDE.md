...
other's view cannot read" is data. 542 keys are in it (counted two ways on 2026-08-22 and
...
numbers this epic has produced from an instrument that looked right).
