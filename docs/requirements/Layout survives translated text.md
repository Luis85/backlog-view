...
| `corner-left-up` | a card's parent line, `board.ts` | The cue that names the item above |
...
`src/view/render/board.ts` the card's parent cue · `src/view/interactions/menu.ts` the
