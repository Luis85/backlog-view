...
The tree stays where it is. It is the one projection whose configuration the others were
borrowing.

**Outcome** — The backlog view is a backlog again, and each projection it was carrying is
a view a vault can choose not to have.
